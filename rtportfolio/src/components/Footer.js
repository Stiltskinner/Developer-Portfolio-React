        ...
        <footer className="container-fluid row justify-content-md-start justify-content-center lgray-back position-sticky bottom-0" id="sec-contact" title="Contact-Me">
          <div className="d-flex col-12 align-items-center justify-content-center">
            <ul className="nav col-12 flex-wrap text-md-start text-start justify-content-center">
              ...
              <li className="col-lg-2 col-12"><a href="https://github.com/Stiltskinner" target="_blank" rel="noreferrer" className="contact-link ">Github</a></li>
              <li className="col-lg-2 col-12"><a href="https://www.linkedin.com/in/ryanpaxthomas/" target="_blank" rel="noreferrer" className="contact-link ">LinkedIn</a></li>
              <li className="col-lg-2 col-12"><a href="https://twitter.com/Stiltskinner" target="_blank" rel="noreferrer" className="contact-link ">Twitter</a></li>
            </ul>
          </div>
      </footer>
    );
