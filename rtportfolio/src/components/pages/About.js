...
export default function About() {
  return (
<section className="container-fluid row justify-content-md-start justify-content-center align-items-start mb-3" id="sec-about-me"
      title="About Me">
      <h2 className="ms-5 text-center">About Me</h2>
